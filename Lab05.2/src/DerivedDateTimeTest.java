...
class DerivedDateTimeTest {
    ...
    public static void testPopularBirthdays() {
        ...
        LocalDate res = vDay.plusWeeks(38);
    ...
    public static void testEarlyRetirement() {
        LocalDate bday = LocalDate.of(1996, 12, 27);
    ...
    public static void testElectionDay() {
        ...
        LocalDate eday = nov2.with(nextOrSame(TUESDAY));
    ...
    public static void testAnniversary() {
        LocalDate wed = LocalDate.of(1969, 6,6);
        LocalDate ann = wed.plusYears(50);
        LocalDate party = ann.with(nextOrSame(SATURDAY));
