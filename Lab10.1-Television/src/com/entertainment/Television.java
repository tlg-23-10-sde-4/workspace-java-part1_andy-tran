...
public class Television {
    ...
    public Television(int volume, String brand) throws IllegalArgumentException, InvalidBrandException {
        this(brand);
        setVolume(volume);
    }
    ...
    public void setVolume(int volume) throws IllegalArgumentException {
        if (volume >= 0 && volume <= 100) {
            ...
            throw new IllegalArgumentException("Volume " + volume + " not in range of 0 - 100.");
        }
    }
    ...
    public void setBrand(String brand) throws InvalidBrandException{
        ...
        if(isValidBrand(brand)) {
            ...
            throw new InvalidBrandException("Invalid brand: " + brand + " Must be one of " + Arrays.toString(VALID_BRANDS));
        }
    }
